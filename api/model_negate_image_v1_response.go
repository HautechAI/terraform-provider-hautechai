...
// checks if the NegateImageV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegateImageV1Response{}

// NegateImageV1Response struct for NegateImageV1Response
...
type _NegateImageV1Response NegateImageV1Response
...
func (o NegateImageV1Response) MarshalJSON() ([]byte, error) {
...
func (o NegateImageV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *NegateImageV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varNegateImageV1Response := _NegateImageV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegateImageV1Response)

	if err != nil {
		return err
	}

	*o = NegateImageV1Response(varNegateImageV1Response)

	return err
}

type NullableNegateImageV1Response struct {
	value *NegateImageV1Response
	isSet bool
}

func (v NullableNegateImageV1Response) Get() *NegateImageV1Response {
	return v.value
}

func (v *NullableNegateImageV1Response) Set(val *NegateImageV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNegateImageV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNegateImageV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegateImageV1Response(val *NegateImageV1Response) *NullableNegateImageV1Response {
	return &NullableNegateImageV1Response{value: val, isSet: true}
}

func (v NullableNegateImageV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegateImageV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
