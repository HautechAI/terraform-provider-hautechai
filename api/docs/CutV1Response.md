...
`func (o *CutV1Response) SetKind(v string)`
...
`func (o *CutV1Response) GetStatus() string`
...
`func (o *CutV1Response) GetCreatorId() string`
...
`func (o *CutV1Response) GetUpdatedAt() time.Time`
