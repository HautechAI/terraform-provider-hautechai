...
`func (o *HauteNaomiV1Response) SetKind(v string)`
...
`func (o *HauteNaomiV1Response) GetStatus() string`
...
`func (o *HauteNaomiV1Response) GetCreatorId() string`
...
`func (o *HauteNaomiV1Response) GetUpdatedAt() time.Time`
