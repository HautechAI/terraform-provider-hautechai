...
// checks if the SegmentAnythingEmbeddingsV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentAnythingEmbeddingsV1Response{}

// SegmentAnythingEmbeddingsV1Response struct for SegmentAnythingEmbeddingsV1Response
...
type _SegmentAnythingEmbeddingsV1Response SegmentAnythingEmbeddingsV1Response
...
func NewSegmentAnythingEmbeddingsV1Response(kind string, output NullableOperationOutputJSON, input map[string]interface{}, status string, type_ string, id string, creatorId string, metadata map[string]interface{}, createdAt time.Time, updatedAt time.Time) *SegmentAnythingEmbeddingsV1Response {
	this := SegmentAnythingEmbeddingsV1Response{}
	this.Kind = kind
	this.Output = output
	this.Input = input
	this.Status = status
...
func (o SegmentAnythingEmbeddingsV1Response) MarshalJSON() ([]byte, error) {
...
func (o SegmentAnythingEmbeddingsV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *SegmentAnythingEmbeddingsV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSegmentAnythingEmbeddingsV1Response := _SegmentAnythingEmbeddingsV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSegmentAnythingEmbeddingsV1Response)

	if err != nil {
		return err
	}

	*o = SegmentAnythingEmbeddingsV1Response(varSegmentAnythingEmbeddingsV1Response)

	return err
}

type NullableSegmentAnythingEmbeddingsV1Response struct {
	value *SegmentAnythingEmbeddingsV1Response
	isSet bool
}

func (v NullableSegmentAnythingEmbeddingsV1Response) Get() *SegmentAnythingEmbeddingsV1Response {
	return v.value
}

func (v *NullableSegmentAnythingEmbeddingsV1Response) Set(val *SegmentAnythingEmbeddingsV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSegmentAnythingEmbeddingsV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSegmentAnythingEmbeddingsV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSegmentAnythingEmbeddingsV1Response(val *SegmentAnythingEmbeddingsV1Response) *NullableSegmentAnythingEmbeddingsV1Response {
	return &NullableSegmentAnythingEmbeddingsV1Response{value: val, isSet: true}
}

func (v NullableSegmentAnythingEmbeddingsV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSegmentAnythingEmbeddingsV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
