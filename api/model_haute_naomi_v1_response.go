...
// checks if the HauteNaomiV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HauteNaomiV1Response{}

// HauteNaomiV1Response struct for HauteNaomiV1Response
...
type _HauteNaomiV1Response HauteNaomiV1Response
...
func (o HauteNaomiV1Response) MarshalJSON() ([]byte, error) {
...
func (o HauteNaomiV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *HauteNaomiV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varHauteNaomiV1Response := _HauteNaomiV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHauteNaomiV1Response)

	if err != nil {
		return err
	}

	*o = HauteNaomiV1Response(varHauteNaomiV1Response)

	return err
}

type NullableHauteNaomiV1Response struct {
	value *HauteNaomiV1Response
	isSet bool
}

func (v NullableHauteNaomiV1Response) Get() *HauteNaomiV1Response {
	return v.value
}

func (v *NullableHauteNaomiV1Response) Set(val *HauteNaomiV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableHauteNaomiV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableHauteNaomiV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHauteNaomiV1Response(val *HauteNaomiV1Response) *NullableHauteNaomiV1Response {
	return &NullableHauteNaomiV1Response{value: val, isSet: true}
}

func (v NullableHauteNaomiV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHauteNaomiV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
