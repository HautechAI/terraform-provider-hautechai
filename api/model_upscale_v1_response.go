...
// checks if the UpscaleV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpscaleV1Response{}

// UpscaleV1Response struct for UpscaleV1Response
...
type _UpscaleV1Response UpscaleV1Response
...
func (o UpscaleV1Response) MarshalJSON() ([]byte, error) {
...
func (o UpscaleV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpscaleV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpscaleV1Response := _UpscaleV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpscaleV1Response)

	if err != nil {
		return err
	}

	*o = UpscaleV1Response(varUpscaleV1Response)

	return err
}

type NullableUpscaleV1Response struct {
	value *UpscaleV1Response
	isSet bool
}

func (v NullableUpscaleV1Response) Get() *UpscaleV1Response {
	return v.value
}

func (v *NullableUpscaleV1Response) Set(val *UpscaleV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpscaleV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpscaleV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpscaleV1Response(val *UpscaleV1Response) *NullableUpscaleV1Response {
	return &NullableUpscaleV1Response{value: val, isSet: true}
}

func (v NullableUpscaleV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpscaleV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
