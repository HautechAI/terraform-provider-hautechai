...
// checks if the SegmentAnythingMaskV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentAnythingMaskV1Response{}

// SegmentAnythingMaskV1Response struct for SegmentAnythingMaskV1Response
...
type _SegmentAnythingMaskV1Response SegmentAnythingMaskV1Response
...
func NewSegmentAnythingMaskV1Response(kind string, output NullableOperationOutputImageSingle, input map[string]interface{}, status string, type_ string, id string, creatorId string, metadata map[string]interface{}, createdAt time.Time, updatedAt time.Time) *SegmentAnythingMaskV1Response {
	this := SegmentAnythingMaskV1Response{}
	this.Kind = kind
	this.Output = output
	this.Input = input
	this.Status = status
...
func (o SegmentAnythingMaskV1Response) MarshalJSON() ([]byte, error) {
...
func (o SegmentAnythingMaskV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *SegmentAnythingMaskV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSegmentAnythingMaskV1Response := _SegmentAnythingMaskV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSegmentAnythingMaskV1Response)

	if err != nil {
		return err
	}

	*o = SegmentAnythingMaskV1Response(varSegmentAnythingMaskV1Response)

	return err
}

type NullableSegmentAnythingMaskV1Response struct {
	value *SegmentAnythingMaskV1Response
	isSet bool
}

func (v NullableSegmentAnythingMaskV1Response) Get() *SegmentAnythingMaskV1Response {
	return v.value
}

func (v *NullableSegmentAnythingMaskV1Response) Set(val *SegmentAnythingMaskV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSegmentAnythingMaskV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSegmentAnythingMaskV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSegmentAnythingMaskV1Response(val *SegmentAnythingMaskV1Response) *NullableSegmentAnythingMaskV1Response {
	return &NullableSegmentAnythingMaskV1Response{value: val, isSet: true}
}

func (v NullableSegmentAnythingMaskV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSegmentAnythingMaskV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
