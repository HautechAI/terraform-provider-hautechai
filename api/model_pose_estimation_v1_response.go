...
// checks if the PoseEstimationV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoseEstimationV1Response{}

// PoseEstimationV1Response struct for PoseEstimationV1Response
...
type _PoseEstimationV1Response PoseEstimationV1Response
...
func (o PoseEstimationV1Response) MarshalJSON() ([]byte, error) {
...
func (o PoseEstimationV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *PoseEstimationV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPoseEstimationV1Response := _PoseEstimationV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPoseEstimationV1Response)

	if err != nil {
		return err
	}

	*o = PoseEstimationV1Response(varPoseEstimationV1Response)

	return err
}

type NullablePoseEstimationV1Response struct {
	value *PoseEstimationV1Response
	isSet bool
}

func (v NullablePoseEstimationV1Response) Get() *PoseEstimationV1Response {
	return v.value
}

func (v *NullablePoseEstimationV1Response) Set(val *PoseEstimationV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePoseEstimationV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePoseEstimationV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoseEstimationV1Response(val *PoseEstimationV1Response) *NullablePoseEstimationV1Response {
	return &NullablePoseEstimationV1Response{value: val, isSet: true}
}

func (v NullablePoseEstimationV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoseEstimationV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
