...
// checks if the CutV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CutV1Response{}

// CutV1Response struct for CutV1Response
...
type _CutV1Response CutV1Response
...
func (o CutV1Response) MarshalJSON() ([]byte, error) {
...
func (o CutV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *CutV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCutV1Response := _CutV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCutV1Response)

	if err != nil {
		return err
	}

	*o = CutV1Response(varCutV1Response)

	return err
}

type NullableCutV1Response struct {
	value *CutV1Response
	isSet bool
}

func (v NullableCutV1Response) Get() *CutV1Response {
	return v.value
}

func (v *NullableCutV1Response) Set(val *CutV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCutV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCutV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCutV1Response(val *CutV1Response) *NullableCutV1Response {
	return &NullableCutV1Response{value: val, isSet: true}
}

func (v NullableCutV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCutV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
