...
// checks if the InpaintKateV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InpaintKateV1Response{}

// InpaintKateV1Response struct for InpaintKateV1Response
...
type _InpaintKateV1Response InpaintKateV1Response
...
func (o InpaintKateV1Response) MarshalJSON() ([]byte, error) {
...
func (o InpaintKateV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *InpaintKateV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varInpaintKateV1Response := _InpaintKateV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInpaintKateV1Response)

	if err != nil {
		return err
	}

	*o = InpaintKateV1Response(varInpaintKateV1Response)

	return err
}

type NullableInpaintKateV1Response struct {
	value *InpaintKateV1Response
	isSet bool
}

func (v NullableInpaintKateV1Response) Get() *InpaintKateV1Response {
	return v.value
}

func (v *NullableInpaintKateV1Response) Set(val *InpaintKateV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInpaintKateV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInpaintKateV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInpaintKateV1Response(val *InpaintKateV1Response) *NullableInpaintKateV1Response {
	return &NullableInpaintKateV1Response{value: val, isSet: true}
}

func (v NullableInpaintKateV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInpaintKateV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
